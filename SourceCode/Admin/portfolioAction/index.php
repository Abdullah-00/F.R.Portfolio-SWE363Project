...
<body>
  ...
  Portfolio <i class="fa fa-caret-down"></i>
        ...
        <div id="demoAcc" class="w3-hide w3-white w3-card">
            ...
            <a href="deletePortfolio.php" class="w3-bar-item w3-button">Delete Portfolio</a>
            <a href="" class="w3-bar-item w3-button">Approve Portfolio Request</a>
        </div>
						...
						echo '<table class="table table-hover table-responsive">
								<thead>
									<tr>
										...
										<th valign="middle">Approve/Reject</th>
									</tr>
								</thead>
								<tbody>';
						$count = 1;
